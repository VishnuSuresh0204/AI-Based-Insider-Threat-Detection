...
class Alert(models.Model):
    """
    A notification created when risk crosses a threshold. What the
    admin dashboard actually lists.
    """
    STATUS_CHOICES = [
        ("OPEN", "Open"),
    ...
    def __str__(self):
        return f"Alert #{self.pk} - {self.risk_assessment.activity.loginid.username}"